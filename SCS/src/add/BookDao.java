...
public class BookDao {
	...
	public static boolean save(String name, String section) {
		...
		try {
			...
			Connection con = DriverManager.getConnection(
					"jdbc:mysql://localhost:3306/classes", "root", "root");
			...
			PreparedStatement oPrStmt = con
					.prepareStatement("INSERT INTO classes (Coursename,section) VALUES(?,?)");// ? represents some parameter to include
																							
			oPrStmt.setString(1, name);// parameter index start from 1
			oPrStmt.setString(2, section);
